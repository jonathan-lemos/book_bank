defmodule BookBank.DatabaseBehavior do
  ...
  @callback get_book_file(id :: String.t()) ::
              {:ok, Enumerable.t(), BookBank.Book} | {:error, :does_not_exist | String.t()}
  @callback get_book_thumb(id :: String.t()) ::
              {:ok, Enumerable.t(), BookBank.Book} | {:error, :does_not_exist | String.t()}
  @callback get_book_cover(id :: String.t()) ::
              {:ok, Enumerable.t(), BookBank.Book} | {:error, :does_not_exist | String.t()}
  @callback update_book(
              id :: String.t(),
              update ::
                list(
                  {:set_metadata, %{String.t() => String.t()}}
